...
public class Main {
    public static void main(String[] args) {
        FriendshipRepository repoFriendship = new FriendshipRepository(new FriendshipValidator(),"./data/friendships.txt");
        UserRepository repoUser = new UserRepository(new UserValidator(),"./data/users.txt");
